  ...
  if (!fs.existsSync(DATA_FILE)) {
    const seed = {
      ...
      shelters: [
        {
          id: uid('sh'),
          name: "Guwahati-5 — St. Xavier's School",
          area: 'Guwahati',
          capacity: 500,
          occupied: 347,
          hasFood: true,
...
app.listen(PORT, HOST, () => {
  ...
  console.log(`AI Features: PyTorch Local Model Active | Twilio=${!!process.env.TWILIO_ACCOUNT_SID} | ORS=${!!process.env.ORS_API_KEY}`);
});
